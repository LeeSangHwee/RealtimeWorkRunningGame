...
export const gameStart = (uuid, payload) => {
    ...
    // 각 배열에서 0번째로 저장
    setStage(uuid, stages.data[0].id, payload.timestamp, stages.data[0].scorePerSecond);
    setItem(uuid, items.data[0].id, items.data[0].score, items.data[0].width, items.data[0].height, items.data[0].image);
