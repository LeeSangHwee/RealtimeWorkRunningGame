...
import { getNextStage, getUnlockItem } from './handlers/response.handler.js';
...
// 아이템 아이템 DB 전달 필요
const ITEM_CONFIG = getUnlockItem();
...
function updateGameSpeed(deltaTime) {
  gameSpeed += deltaTime * GAME_SPEED_INCREMENT * getNextStage().scorePerSecond;
}
